...
const imgSrc = [];
img.forEach(item => imgSrc.push(item.src));
let currentIndex = 0;
let allowChange = true;
let contentIndex = 0;

// control the behaviour of control buttons
...
// hide the lightbox when modal is clicked
...
// hide the light box when user press Escape or control/navigate using arrow keys
...
// functionality to toggle the control button
